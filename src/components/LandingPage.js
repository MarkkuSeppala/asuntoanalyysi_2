        ...
        <div className="container">
          <div className="row align-items-center hero-content">
            <div className="col-lg-7 col-md-12">
              ...
              <p className="hero-subtitle">Kotiko auttaa sinua analysoimaan potentiaalisia asuntokohteita syvällisesti ja tunnistamaan piilevät riskit ja mahdollisuudet.</p>
            ...
            <div className="col-lg-5 d-none d-lg-block">
              <img src="/static/img/hero-image.svg" alt="Kotiko" className="img-fluid" onError={(e) => {e.target.style.display='none'}} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container" style={{paddingTop: '50px'}}>
          <div className="row text-center mb-5">
            <div className="col-lg-12">
              ...
              <p className="section-subtitle mx-auto">Kotiko tarjoaa kattavan työkalupaketin, joka auttaa sinua tekemään parempia sijoituspäätöksiä.</p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row text-center mb-5">
            <div className="col-lg-12">
              ...
              <p className="section-subtitle mx-auto">Kotiko on suunniteltu helppokäyttöiseksi. Näin pääset alkuun:</p>
            </div>
          </div>
